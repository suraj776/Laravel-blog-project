...
<body>
    <div id="header-wrapper">
        <div id="header" class="container">
            ...
            <div id="menu">
                <ul>
                    <li class="{{ Request::path() === 'simplework'? 'current_page_item' : ''}}">
                        <a href="/simplework" accesskey="1" title="">Homepage</a>
                    </li>
                    <li class="{{ Request::path() === 'client'? 'current_page_item' : ''}}">
                    ...
                    <li class="{{ Request::path('articles') === 'articles'? 'current_page_item' : ''}}">
